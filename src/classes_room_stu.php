<?php 
    ...
    if (isset($_POST['update'])) {
        ...
        header("Location: classes_room_stu.php?classCode=$classCode");
    }
        ...
        if (in_array($fileActualExt, $allowed)) {
            if ($fileError === 0) {
                if ($fileSize < 1000000000000) {
                    ...
                    header("Location: classes_room_stu.php?classCode=$classCode&uploadsuccess");
                } 
                else {
...
<div class=Wrapper2>
    <div class="user_details cloumn">
        ...
        <p style='line-height:30px; display: inline-block;'><b>Section:</b> <?php echo $sec ?>
            ...
            <!-- <span id="code_expand"><i class="fas fa-expand-arrows-alt"></i></span> -->
        </p>
        </form>
    ...
    <div id="modal2">
        ...
        <div id="edit_box">
            <form class="edit_form" method="POST">
                ...
                <a href="classes_room_stu.php?classCode=$classCode"><input type="submit" name="cancel" value="Cancel" class="edit_box_btn" id="update_cancel_btn"></a>
    ...
    <div class="main_column">
        ...
        <div id="second">
            <form class="assignment_form" method="POST" enctype="multipart/form-data">
                ...
                <a href='classes_room_stu.php?classCode=$courseCode'><input type='submit' name='upload' id='assignment-upload-button' value='Upload'></a>
                <hr>
            </form>
            <?php
            $post = new Post($con, $userLoggedIn, $classCode);
