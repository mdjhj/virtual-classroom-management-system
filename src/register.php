<?php 
require 'config.php';
require 'form_handlers_register_handler.php';
require 'form_handlers_login_handler.php';
?>
...
<body>
    ...
    <div class="wrapper">
        <div class="landing">
            ...
            <div class="content">
                <h6>Join Your Class From Anywhere Anytime</h6>
        ...
        <div class="login_box">
            ...
            <div id="second">
                <form action="register.php" method="POST" id="register-form">
                    <input type="text" name="role" placeholder="Are you a Teacher or Student?" value="<?php if (isset($_SESSION['role'])) {
                            echo $_SESSION['role'];
                            } ?>" required>
