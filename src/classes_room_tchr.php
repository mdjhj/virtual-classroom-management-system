<?php 
    ...
    if (isset($_POST['update'])) {
        ...
        header("Location: classes_room_tchr.php?classCode=$classCode");
    }
        ...
        if (in_array($fileActualExt, $allowed)) {
            if ($fileError === 0) {
                if ($fileSize < 1000000000000) {
                    ...
                    header("Location: classes_room_tchr.php?classCode=$classCode&uploadsuccess");
                } 
                else {
...
<div class=Wrapper2>
    <div class="user_details cloumn">
        ...
        <div class="assignment_box">
            <a href="https://livesessionclassroom.herokuapp.com" target="_blank"><i class="fas fa-video" style='margin-right: 5px;'></i>Session</a>

            <a href="#" id="postBtn"><i class="fab fa-megaport" style='margin-right: 5px;'></i>Post</a>
            
            <a href="#" id="assignmentBtn"><i class="far fa-file-word" style='margin-right: 5px;'></i>Resources</a>
        </div>
    </div>
    ...
    <div id="modal2">
        ...
        <div id="edit_box">
            <form class="edit_form" method="POST">
                <textarea name="editedPost_text" id="edit_textarea"><?php echo $body[0]; ?></textarea>
                <a href="classes_room_tchr.php?classCode=$classCode"><input type="submit" name="cancel" value="Cancel" class="edit_box_btn" id="update_cancel_btn"></a>
    ...
    <div class="people_column">
       <h4>Instructor:</h4><?php echo $teacherDetails['first_name'] . " " . $teacherDetails['last_name'] ?>
        <br>
    ...
    <div class="main_column">
        ...
        <div id="second">
            <form class="assignment_form" method="POST" enctype="multipart/form-data">
                ...
                <a href='classes_room_tchr.php?classCode=$courseCode'><input type='submit' name='upload' id='assignment-upload-button' value='Upload'></a>
            </form>
            <?php
            $post = new Post($con, $userLoggedIn, $classCode);
            $post->loadFiles();
